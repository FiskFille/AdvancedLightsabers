...
public class MowzieModelBase extends ModelBiped
{
    ...
    protected void rotateTo(ModelRenderer rotating, ModelRenderer to, float t)
    {
        ...
        rotating.rotateAngleX += rotXDif * t;
        rotating.rotateAngleY += rotYDif * t;
        rotating.rotateAngleZ += rotZDif * t;

        rotating.offsetX += offsetXDif * t;
        rotating.offsetY += offsetYDif * t;
        rotating.offsetZ += offsetZDif * t;

        rotating.rotationPointX += posXDif * t;
        rotating.rotationPointY += posYDif * t;
        rotating.rotationPointZ += posZDif * t;
    }
