...
public class RenderLightsaberPart implements IItemRenderer
{
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data)
    {
        ...
        float height = partType == EnumPartType.EMITTER ? lightsaber.getEmitter().height : (partType == EnumPartType.SWITCH_SECTION ? lightsaber.getSwitchSection().height : (partType == EnumPartType.BODY ? lightsaber.getBody().height : lightsaber.getPommel().height));
