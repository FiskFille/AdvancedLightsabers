...
import static fiskfille.lightsabers.common.generator.ModChestGen.SITH_TOMB_ANNEX;
import static fiskfille.lightsabers.common.generator.ModChestGen.SITH_TOMB_COFFIN;
import static fiskfille.lightsabers.common.generator.ModChestGen.SITH_TOMB_TREASURY;
...
public class StructureSithTomb extends Structure
{
	...
	private void generateEntrance(Random random)
	{
		...
		setBlock(Blocks.redstone_block, 0, 0, 0, 3);
		setBlock(Blocks.redstone_block, 0, 1, 0, 4);
		setBlock(Blocks.redstone_block, 0, -1, 0, 4);
		setBlock(Blocks.redstone_block, 0, 0, 0, 5);
		setBlock(Blocks.redstone_block, 0, 1, 0, 6);
		setBlock(Blocks.redstone_block, 0, -1, 0, 6);
		setBlock(Blocks.redstone_block, 0, 0, 0, 7);
		setBlock(Blocks.redstone_block, 0, 0, 0, 8);
	...
	private void generateAntechamber(Random random)
	{
		...
		for (int i = 0; i < 15; ++i)
		{
			...
			if (flag || i == 7)
			{
				setBlock(Blocks.redstone_block, 1, 7 - i, -1, 5);
				setBlock(Blocks.redstone_block, 1, 7 - i, -1, 7);
			}
			
			if (!flag || i == 7)
			{
				setBlock(Blocks.redstone_block, 1, 7 - i, -1, 6);
			}
		}
	...
	private void generateBurialChamber(Random random)
	{
		...
		for (int i = 0; i < 5; ++i)
		{
			if (i == 0 || i == 3)
			{
				setBlock(Blocks.redstone_block, 0, -6 - i, -1, 0);
			}
			else
			{
				setBlock(Blocks.redstone_block, 0, -6 - i, -1, 1);
				setBlock(Blocks.redstone_block, 0, -6 - i, -1, -1);
			}
		}
