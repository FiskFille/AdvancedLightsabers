...
import static fiskfille.lightsabers.common.generator.ModChestGen.JEDI_TEMPLE;
...
{
	public StructureJediTemple(World world, int x, int y, int z)
	{
		super(world, x, y, z);
	}
	...
	public void spawnStructure(Random random)
	{
		...
		for (int layer = 0; layer < 2; ++layer)
		{
			...
			/**
			 * Congrats! You just found an easter egg in the code.
			 * [~o~] Redeem this token at twitter.com/FiskFille
			 * for a prize, a shoutout and (if in a good mood) a
			 * pat on the back.
			 */
