...
public class BlockSithStoneCoffin extends BlockContainer
{
    ...
    {
        setBounds(world, x, y, z, world.getBlockMetadata(x, y, z));
    ...
    public void setBounds(IBlockAccess world, int x, int y, int z, int metadata)
    {
        if (metadata >= 4)
        {
            --y;
    ...
    {
        int rotation = MathHelper.floor_double((entity.rotationYaw * 4F) / 360F + 2.5D) & 3;
    ...
    {
        blockIcon = par1IIconRegister.registerIcon("hardened_clay_stained_black");
    }
}
