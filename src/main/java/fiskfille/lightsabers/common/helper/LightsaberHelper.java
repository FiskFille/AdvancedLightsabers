...
public class LightsaberHelper
{
    ...
    {
        ItemStack itemstack = new ItemStack(type == EnumPartType.EMITTER ? ModItems.lightsaberEmitter : (type == EnumPartType.SWITCH_SECTION ? ModItems.lightsaberSwitchSection : (type == EnumPartType.BODY ? ModItems.lightsaberBody : ModItems.lightsaberPommel)));
        NBTTagCompound nbttagcompound = new NBTTagCompound();
    ...
    {
        return entity instanceof IProjectile || entity instanceof EntityPlayer || entity instanceof EntitySithGhost;
    }
