...
{
    public Part[] parts = {new Part(EnumPartType.EMITTER, 16), new Part(EnumPartType.SWITCH_SECTION, 8.8F), new Part(EnumPartType.BODY, 16), new Part(EnumPartType.POMMEL, 1)};
