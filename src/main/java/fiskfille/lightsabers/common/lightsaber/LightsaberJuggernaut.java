...
{
    public Part[] parts = {new Part(EnumPartType.EMITTER, 14.7F), new Part(EnumPartType.SWITCH_SECTION, 12.4F), new Part(EnumPartType.BODY, 16), new Part(EnumPartType.POMMEL, 7)};
