...
{
    public Part[] parts = {new Part(EnumPartType.EMITTER, 19), new Part(EnumPartType.SWITCH_SECTION, 5.6F), new Part(EnumPartType.BODY, 16), new Part(EnumPartType.POMMEL, 8.3F)};
